...
- (void)testMenuRouter {
    ...
    XCTAssertNoThrow([router navigateToSelectedItem:EnumMenuSelectedItemGrid]);
    XCTAssertNoThrow([router navigateToSelectedItem:EnumMenuSelectedItemStack]);
    XCTAssertNoThrow([router navigateToSelectedItem:EnumMenuSelectedItemGallery]);
    XCTAssertNoThrow([router navigateToSelectedItem:EnumMenuSelectedItemCarousel]);
}
